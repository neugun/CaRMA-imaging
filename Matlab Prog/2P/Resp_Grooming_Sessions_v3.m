strFn_Resp = 'Z:\Imaging\2P345\20170820\ANM378231\Reg_Cat\Avg3_nbg\Grooming_E\Resp_Grm_E.mat';
strFn_States='Z:\Imaging\2P345\20170820\ANM378231\States_Grm_S.xlsx';
load(strFn_Resp);
...
%%
idx_rg_c = 1:201; % do functional clustering according to the temporal responses within this range
strPath_Results = [strPath '\Results_' num2str(idx_rg_c(1)) '-' num2str(idx_rg_c(end))];
...
for nType = 1:length(clResultTypes)
    ...
    if(nType ==3)
        ...
        bROC = false;
        stResp_States = PVH_getResp_States_Grooming1(strFn_States,matResp_C,AvgFrm);
