strFn_Resp = 'Z:\Imaging\2P345\20170826\ANM372320\Reg_Cat\Avg3_nbg\Resp.mat';
load(strFn_Resp);
...
%%
idx_rg_c = 155:207; % do functional clustering according to the temporal responses within this range
strPath_Results = [strPath '\Results_CueOn2Cueoff_155-207'];
...
for nType = 1:length(clResultTypes)
    ...
    for nSel = 3:6
        ...
        subplot(1,2,1);
        dendrogram(Z,0,'Orientation','left','ColorThreshold',0.4,'reOrder',idxOrder );
