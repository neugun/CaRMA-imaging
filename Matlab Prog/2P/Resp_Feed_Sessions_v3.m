strFn_Resp = 'Z:\Imaging\2P345\20170821\ANM378231\Reg_Cat\Avg3_nbg\Resp_T4-T8.mat';
strFn_States='Z:\Imaging\2P345\20170821\ANM378231\States.xlsx';
load(strFn_Resp);
[strPath,strFn] = fileparts(strFn_Resp);
%%nNeuronCount = size(matResp,1);

AvgFrm = 3;
vtEvents = [156,157,272];
idxTN_Rg =[50 100];
nTrialCount = 5;
szBin= 5;
%%
...
%%
idx_rg_c = 1:600; % do functional clustering according to the temporal responses within this range
