...
strDir_Img_P = 'Z:\2P_Analyze\ANM318142\20160811_2';
...
for nSlice =1:8
    for nDir =1:nDirCount
        ...
        strFn_S = clFiles{1};
        imgData = readTiffStack(strFn_S);
        strFn_S = [strFn_S(1:end-4) '_UInt16.tif'];
        writeTiffStack_UInt16(imgData,strFn_S);
        fprintf(fid,'%s\n',  strFn_S);
    end
    ...
    C = strsplit(strFn,'_');
    strFn_Sav = [C{1} '_' num2str(vtCatTrials(1)) '-' num2str(vtCatTrials(end)) '_' C{3} '_' C{4} '_Uint16.tif'];
