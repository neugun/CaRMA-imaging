strFn_Resp = 'Z:\Imaging\2P345\20170830\ANM372320\Reg_Cat\Avg3_nbg\Resp.mat';
strFn_States='Z:\Imaging\2P345\20170830\ANM372320\States.xlsx';
load(strFn_Resp);
[strPath,strFn] = fileparts(strFn_Resp);
%%nNeuronCount = size(matResp,1);

AvgFrm = 3;
vtEvents = [451,901,1351,1801,2251,2701,3151];
idxTN_Rg =[101 300];
nTrialCount = 1;
szBin= 20;
%%
...
%%
idx_rg_c = 1:3600; % do functional clustering according to the temporal responses within this range
 dColorThresh = 0.4;
...
%%
vtSel = 1:101;%setxor(1:60,[7 18 19])';
