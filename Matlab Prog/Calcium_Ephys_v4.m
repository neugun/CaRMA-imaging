function hFig = Calcium_Ephys_v4(ephysFile,xlsfile,stOption)

if (nargin ==0)
    ephysFile = 'Y:\FigsLayout\Scott_talk\Slice\C1\AA0001AAAA0001.xsg';
    xlsfile='Y:\FigsLayout\Scott_talk\Slice\C1\01-07-15-12-14-06.xls';
end
