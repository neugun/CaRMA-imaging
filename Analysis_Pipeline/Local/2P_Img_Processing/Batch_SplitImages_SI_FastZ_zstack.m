...
% Saintgene 2016
%%
function stEvents = Batch_SplitImages_SI_FastZ_zstack(strDir)
...
strImg_RE = '\d{5}_Comb_C1_reg.tif$';
...
%     strDir_Sub = SplitImages_SI_header(strFn);  
                                     %%%%%%%%%%%%%% edit by Zhenggang zhu
    strDir_Sub = SplitImages_SI_FastZ_zstack(strFn);
